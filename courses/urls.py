...
urlpatterns = [
    ...
    path('private_session_history/<int:pk>/', views.PrivateSessionHistoryView.as_view(), name='private-session-history'),
    path('private_session_manage/<int:step_progress_id>/', views.PrivateSessionManageView.as_view(), name='private-session-manage'),
    ...
    path('group_session_history/<int:pk>/', views.GroupSessionHistoryView.as_view(), name='group-session-history'),
]
