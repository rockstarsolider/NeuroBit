    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('expired', 'Expired')], db_index=True, default='active', max_length=12)),
        ...
        migrations.AddIndex(
            model_name='learnersubscribeplan',
            index=models.Index(fields=['start_datetime'], name='courses_lea_start_d_a0434f_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='task',
