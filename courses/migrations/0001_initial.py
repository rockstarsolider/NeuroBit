# Generated by Django 5.2.4 on 2025-07-29 19:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.PositiveSmallIntegerField(default=0, help_text='% discount (e.g.\xa010\xa0=>\xa010%)', validators=[django.core.validators.MaxValueValidator(100, '100% discount is the highest valid amount!')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('google_meet_record', models.URLField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('learner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='group_sessions', to='courses.learner')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='participants', to='courses.mentorgroupsession')),
            ],
        ),
        migrations.CreateModel(
            name='Resources',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('learning_path', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='session_templates', to='courses.learningpath')),
                ('mentor_assignment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='session_templates', to='courses.mentorassignment')),
