    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentor_group_session_occurence', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='participants', to='courses.mentorgroupsessionocuurence')),
            ],
        ),
        migrations.CreateModel(
            name='Resources',
